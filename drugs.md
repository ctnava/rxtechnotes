...
A class is a broad category of drugs that work in similar ways or treat similar conditions; reflective of

- Mechanism of Action
- Therapeutic Use
- Chemical Structure

Drug classes are **not legally standardized**; different references may classify the same drug differently.

> A **class** is about **what the drug does**, not what it’s named. They organize drugs for clinical reference, education, and prescribing.

---

## How Drugs Are Named (with Stems)

`Stems evolve as new drug families appear.`

A stem is a naming pattern built into the generic drug name that hints at its class. Stems are syllables placed at the **beginning**, **middle**, or **end** of a drug name.

> A **stem** is about **how the drug is named**, not what it treats. They help clinicians instantly recognize what type of drug they're dealing with.

### United States Adopted Names (USAN) Council

The **USAN Council** designates official **non‑proprietary (generic) drug names**.
...
2. **Code Number / Development Name**  
   ...
   - If the compound shows promise, the **sponsoring company** initiates the naming process by submitting a proposed nonproprietary name & class to USAN and international regulatory agencies.

3. **Generic (Nonproprietary) Name**
   - Assigned once USAN approves the proposed name & pharmacologic or therapeutic classification (that its stems are based on).
...
A number of classifications are based on whether drugs influence the parasympathetic or sympathetic nervous system.  
Most organs in the body are influenced by both systems. These systems generally stimulate opposing responses, which balance their effects and maintain a normal state of homeostasis.

**Homeostasis**  
A stable internal environment maintained by balancing physiological processes.

Drugs that act on the parasympathetic system are called **cholinergic**, because acetylcholine is the neurotransmitter of this system.

**Neurotransmitter**  
A chemical messenger released by neurons to transmit signals across synapses to other neurons, muscles, or glands.

Drugs that act on the sympathetic nervous system are called **adrenergic**, because the neurotransmitters norepinephrine and epinephrine are secreted from the adrenal glands.

### Classification by Receptor Activity
...
Each neurotransmitter has multiple receptor subtypes, each with agonists and antagonists that act through various mechanisms.
