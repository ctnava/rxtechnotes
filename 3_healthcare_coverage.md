...
| 📋 **Formulary Management** | PBMs design **formularies**—lists of covered drugs—and place them into **tiers** that affect pricing and access. |
...
| 🅱️   | Medical Insurance  | Doctor visits, outpatient services, preventive care, DME | Monthly premium, deductible, 20% coinsurance | Optional; penalty if you delay enrollment |
...
| 🍩 **Coverage Gap ("Donut Hole")** | You pay **25% of drug costs** (brand & generic). |
