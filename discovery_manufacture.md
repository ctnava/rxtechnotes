...
flowchart TD
    ...
    Notes: See Step 5, below, for further detail"]
...
The USAN Council reviews the sponsor’s proposal and assigns the official **generic name**, while brand names are created later for marketing.

Link to 🔗 [How Drugs are Classified & Named](./drugs.md#how-drugs-are-classified)
