...
**Grapefruit** and **grapefruit juice** contain natural compounds called **furanocoumarins** (e.g., bergamottin, 6',7'-dihydroxybergamottin).  
These compounds **inhibit intestinal CYP3A4 enzymes** and **P‑glycoprotein (P‑gp) transporters**, both of which normally help metabolize or pump drugs out of the gut.

When these systems are inhibited:

- **Less drug is metabolized in the intestine**
- **More drug enters systemic circulation**
- **Blood levels rise higher than intended**
- **Risk of toxicity increases**, especially for narrow‑therapeutic‑window drugs

This effect can last **24–72 hours** after consuming grapefruit.

##### Mechanisms

- **CYP3A4 inhibition** → decreased first‑pass metabolism → ↑ drug concentration  
- **P‑gp inhibition** → decreased efflux from enterocytes → ↑ absorption  
- **Irreversible enzyme inhibition** → body must synthesize new CYP3A4 enzymes  

> Even one glass of grapefruit juice can significantly increase drug exposure.

##### Do NOT Take With Grapefruit

These drugs rely heavily on **CYP3A4** or **P‑gp** for metabolism or transport:

###### **Cardiovascular**

- **Calcium Channel Blockers**  
  - amlodipine, felodipine, nifedipine, verapamil  
- **Statins**  
  - simvastatin, lovastatin, atorvastatin  
  - *Note:* pravastatin & rosuvastatin are safer alternatives

###### **Psychiatric**

- **SSRIs**  
  - sertraline, fluoxetine, citalopram (variable but clinically relevant)  
- **Buspirone (Buspar)**  
...
- **Cyclosporine**  
- **Tacrolimus** (less affected but still clinically important)

###### **Antivirals**

- **Saquinavir (Invirase)**  
- Other protease inhibitors may also be affected
