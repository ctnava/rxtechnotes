...
Syringe barrels are selected based on:
...
![[Examples of Various Syringe Barrel Types](https://www.vitalitymedical.com/blog/selecting-syringes-and-needles.html)](./syringeComparison.jpg)

- **Standard Syringes**
  - Marked in **cc OR mL** (directly equivalent)
- **Tuberculin (TB) Syringes**
  - 1 mL capacity  
  - 0.01 mL increments  
  - Used for vaccines, allergy testing, and precise small‑volume doses
- **Insulin Syringes**
  - Marked in **units**, not mL  
  - U‑100 insulin: 100 units = 1 mL
- **Oral Syringes**
  - Marked in **mL only**  
  - Never compatible with needles  
  - Used for oral suspensions and pediatric dosing
