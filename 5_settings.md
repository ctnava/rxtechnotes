...
|---------------------------|----------------|-------------------|
| PTCB Certification (CPhT) | National credential from the Pharmacy Technician Certification Board | 🛒 Retail & 🏥 Hospital |
| ExCPT Certification | Alternative national certification through the NHA | 🛒 Retail |
