...
Before processing any refill request:

- **Check remaining refills** on the patient profile or prescription label  
  - If **refills remain**, proceed  
  - If **no refills remain**, initiate a **renewal request** (see next section)
- Confirm the prescription is still **within its valid date range**  
  - Non-controlled: valid up to **1 year**  
...
- Refills may be denied for:
  ...
  - **Therapeutic duplication or safety flags**
...
- Verify:
  ...
  - No changes in formulation or manufacturer that require pharmacist review  
  - No system alerts requiring pharmacist override

### 🗣️ 4. Communicate with the Patient

Maintain transparency and set expectations:

- Inform the patient of:
  - **How many refills remain**
  - **When the next refill will be due**
  - Any **insurance delays**, **PA requirements**, or **stock issues**
- Provide realistic pickup times based on workflow and inventory
  - Typical promise time is 2 days

> 💬 Clear communication reduces callbacks, improves adherence, and prevents misunderstandings.

### ⚠️ 5. Watch for Red Flags

Technicians must escalate to a pharmacist if:

- The patient reports **changes in therapy**, dose, or prescriber instructions  
...
- **Audit findings**
- **Reversal of payment**
- **Potential legal consequences** for fraud or abuse
...
🗎 Alternate Request Methods Include:
