...
- Worn during **every stage** of HD handling: receipt → storage → compounding → dispensing → administration.
- Must be **chemotherapy‑tested** and certified for HD resistance.  
- Inspect for holes, tears, or imperfections **before donning**.  
...
- Required features:  
  ...
  - Long sleeves  
  - **Tight‑fitting cuffs**  
- For maximum protection during compounding:  
  - **One glove under the gown cuff**,  
  - **One glove over the gown cuff**.
...
## Handling Activities & Work Practices
...
- Always assume **outer packaging, the container within, and package inserts are contaminated**.  
- HD shipments should arrive **sealed in an inner bag** and cushioned inside an outer container.  
- Personnel handling HDs must wear PPE; **double gloves** are required.  
- Never open sealed HD bags without PPE; even if they came from a clean room.  
- Handling can transfer HD residue to **hair, hands, gloves, carts, and surfaces**.

### 📥 Storage

- **Segregate HDs from non‑hazardous inventory** to avoid contaminating other stored products and to limit the number of personnel with access to the products.
- Store in **bins or containers** that prevent falling or breakage.  
- Ideal storage: **negative pressure room** with ≥12 ACPH (per <797>)
- Before placing vials into a PEC:  
  - **Wipe down** with a cloth sprayed with water or alcohol.  
  - Do **not** spray vials directly (risk of aerosolizing contamination).
...
Injectable HDs pose high risk due to concentration and aerosolization potential.

Avoid:

- Pressurizing vials  
- Rapid needle withdrawal  
- Forceful air expulsion from syringes  

High‑risk activities include:

- Reconstitution  
- Drawing from vials/ampules  
- Transferring doses into IV bags  
- Expelling air from HD‑filled syringes

#### Oral Formulations

Oral HDs still pose contamination risk:

- Crushing, grinding, and breakage of tablets/capsules releases powder.  
- Powder is easily aerosolized; contaminating the air and posing dermal contact/ inhalation risk.
- Automated counters impart greater physical stress on capsules/tablets; requiring manual counting

Receiving & transport can lead to deposits of loose powder inside of the bulk container; leading to air contamination and posing dermal contact/ inhalation risk.

High‑risk activities:

- Counting uncoated tablets/capsules  
- Unit‑dosing uncoated products  
- Compounding potent powders  
- Crushing/mixing into liquids or topicals

#### Preparation Inside PECs

- Organize supplies to avoid overcrowding.  
- Avoid reaching in/out of PEC. This causes **residue to fall out**.  
- Residue often accumulates on the **floor in front of PECs**.

#### Containment

- **Never place containment bags inside the PEC.**  
- Seal HDs in containment bags **outside** the PEC with contents visible.  
- After compounding:  
  - clean the finished product
  - Remove **outer gloves** (contaminated).  
  - Use **inner gloves** to label and bag the product.
...
- Decontaminate using the USP <800> sequence:  
  ...
  2. Water rinse  
  3. Sporicidal agent  
- Remove PPE in correct order; perform hand hygiene.

#### Reporting & Follow‑Up

- Document every spill per facility policy.  
- Any exposed employee must complete an incident report and receive medical evaluation.  
